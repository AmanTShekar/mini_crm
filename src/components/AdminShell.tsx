  ...
  return (
    <div className="mx-auto flex min-h-dvh w-full max-w-6xl">
      ...
      <aside className="sticky top-0 hidden h-dvh w-60 shrink-0 flex-col gap-1 border-r border-[#e8e8e4] bg-white/80 p-4 backdrop-blur md:flex">
        ...
        <InstallAppButton className="rounded-[10px] px-3 py-2.5 text-[15px] font-semibold text-[#3d403d] hover:bg-[#f1f1ee]" />
      ...
      <div className="min-w-0 flex-1">
        {/* Mobile top bar */}
        <header
          className="sticky top-0 z-20 flex items-center gap-2 border-b border-[#e8e8e4] bg-[#f7f7f5]/90 px-4 py-3 backdrop-blur md:hidden"
        ...
        {open && (
          <div className="fixed inset-0 z-30 md:hidden">
            ...
            />
            <div className="absolute left-0 top-0 flex h-full w-72 flex-col gap-1 bg-white px-4 pb-[calc(1rem+env(safe-area-inset-bottom))] pt-[calc(1rem+env(safe-area-inset-top))]">
              ...
              <InstallAppButton className="rounded-[10px] px-3 py-3 text-[16px] font-semibold text-[#3d403d] hover:bg-[#f1f1ee]" />
            </div>
          </div>
        )}
        ...
        {/* Mobile bottom nav */}
        <nav className="fixed inset-x-0 bottom-0 z-20 border-t border-[#e8e8e4] bg-white/95 pb-[env(safe-area-inset-bottom)] backdrop-blur md:hidden">
